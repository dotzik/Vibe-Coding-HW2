...
description: V analytických / dokumentačních dokumentech vždy formální zápis bez personifikace (žádné "Novák", "my", "tým", "během analýzy zjišťujeme").
metadata:
  type: feedback
---
...
- jména osob ("Novák otevřel", "Martin požádal") — pokud je atribuce nutná, "reporter ticketu" nebo neuvádět
- první osoba množná ("my", "tým", "během analýzy zjišťujeme")
- vyprávěcí styl ("připojil obrázek", "po prvním pokusu se ukázalo")
- konverzační linky ("k odsouhlasení s Novákem", "ptáme se uživatele")

Místo toho: pasivní rod, neutrální deklarativní věty, **fakta + důsledky + návrhy**.

**Why:** Personifikované zápisy nepůsobí profesionálně a stávají se nečitelné s odstupem času (po měsících čtenář neví, kdo "Novák" nebo "my" byli). Formální analytický styl je vlastní normě connector docs projektu (viz stávající `analysis.md` v projektech) — drží tonalitu konzistentní napříč.
...
- Pokud potřebuješ atribuovat rozhodnutí, použij datum: "Rozhodnuto 2026-05-15: ..." místo "Novák rozhodl...".
...
- "Novák otevřel CONN-235 s minimálním zadáním..."
- "Cíl této session..."
- "Volba k odsouhlasení s Novákem po F1.4"
